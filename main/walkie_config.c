#include <globlaVar.h>
    ...
    static int32_t samples_32bit[128];
    static int16_t samples_16bit[128];
    static uint8_t samples_8bit[128];
    static int16_t receive_16bit[128];
    static int16_t output_16bit[256];
